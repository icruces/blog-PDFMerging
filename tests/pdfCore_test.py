...
import unittest
import os
from app.pdfCore import PdfPyPdf
...
class Test(unittest.TestCase):
    ...
    def testMergin(self):
        ...
        handler.joinPdfs((file1, file2), os.path.join('data', 'result.pdf'))
    ...
    def testSplitPdfBasic(self):
        ...
        handler.splitPdf(file1, splitPoint, self.RESULT_FILE_SPLIT1, self.RESULT_FILE_SPLIT2)
